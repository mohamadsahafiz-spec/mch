              ...
              <table className="w-full text-left border-collapse text-xs">
                <thead>
                  <tr className={`border-b text-[10px] font-mono uppercase ${
                    ...
                    <th className="py-2.5 px-3 font-semibold">Avatar & Full Name</th>
                    ...
                    filteredUsers.map((u) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {/* 2. Role */}
                          <td className="py-3 px-3">
                            <span className={`px-2 py-0.5 rounded-md text-[10px] font-semibold border ${getRoleBadge(u.role)}`}>
                              {u.role}
                            </span>
                          </td>

                          {/* 3. Company */}
                          <td className="py-3 px-3 font-semibold text-slate-200 dark:text-slate-200">
                            {u.company}
                          </td>

                          {/* 4. Department */}
                          <td className="py-3 px-3 text-slate-300 dark:text-slate-300">
                            {u.department}
                          </td>
                          ...
                          <td className="py-3 px-3 text-right">
                            <div className="flex items-center justify-end gap-1.5">
                              {!isActive ? (
                                ...
                                <span className="text-[10px] font-mono font-bold text-emerald-400 flex items-center justify-end gap-1 mr-1">
              ...
              <div className="space-y-5">
                ...
                <div className={`p-4 rounded-xl border text-center space-y-3 relative ${
                  ...
                  {activeUser.id !== selectedUser.id ? (
                    ...
                    <div className="p-2 rounded-lg bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 text-xs font-semibold flex items-center justify-center gap-1.5 font-mono mt-2">
