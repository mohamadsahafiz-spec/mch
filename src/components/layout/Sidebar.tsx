      ...
      <div className={`p-2.5 border-t text-[10px] font-mono flex items-center justify-between ${
        ...
        {!isCollapsed ? (
          <>
            ...
            <span className="font-semibold text-slate-700 dark:text-slate-300">v1.0.2</span>
          </>
        ) : (
          <span className="w-2 h-2 rounded-full bg-emerald-500 mx-auto" title="FSO Engine Online v1.0.2" />
        )}
      </div>
    </aside>
  );
